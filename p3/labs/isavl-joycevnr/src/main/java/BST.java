...
/**
 * Problema da BST: desbalanceamento quando os elementos são inseridos em ordem
 * crescente: busca, inserção e remoção tenham complexidade O(n) em vez de O(log
 * n).
 * Solução: árvores auto-balanceadas, como AVL e Red-Black.
 * Mantém balanceadas automaticamente.
 * Garante a diferença de altura entre sub-árvores esquerda e direita de no
 * máximo 1.
 */
public class BST {
    //Árvores AVL são BSTs autobalanceáveis que mantêm sua altura próxima a log(n).
    ...
    private boolean isAVL(Node node) {
        ...
        // Verifica recursivamente se as subárvores são AVL
    ...
    private int balance(Node node) {
        ...
        //Valores positivos indicam que a árvore está "pendendo" para a esquerda
        //Valores negativos indicam que a árvore está "pendendo" para a direita
        //Este valor deve estar sempre entre -1 e 1.
    }
